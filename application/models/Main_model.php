...
class Main_model extends CI_Model
{
  ...
  public function all_ticket()
  {
    ...
    $query = $this->db->query("SELECT A.id_ticket, A.status, A.tanggal, A.last_update, A.id_prioritas, A.deadline, A.teknisi, A.problem_summary, A.filefoto, B.nama_sub_kategori, C.nama_kategori, D.nama, F.nama_dept, G.nama_prioritas, G.warna, G.waktu_respon, H.lokasi, I.nama_jabatan, K.nama AS nama_teknisi FROM ticket A 
  ...
  public function approve_ticket()
  {
    ...
    $query = $this->db->query("SELECT A.id_ticket, A.status, A.tanggal, A.id_prioritas, A.deadline, A.problem_detail, A.problem_summary, A.filefoto, B.nama_sub_kategori, C.nama_kategori, D.nama, F.nama_dept, G.nama_prioritas, G.warna, H.lokasi, I.nama_jabatan FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori 
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
    LEFT JOIN pegawai D ON D.nik = A.reported 
    LEFT JOIN departemen_bagian E ON E.id_bagian_dept = D.id_bagian_dept 
  ...
  public function pegawai()
  {
    ...
    $query = $this->db->query("SELECT A.nama, A.email, A.nik, B.nama_jabatan, C.nama_bagian_dept, D.nama_dept FROM pegawai A 
  ...
  public function approve_tugas($id)
  {
    ...
    $query = $this->db->query("SELECT A.id_ticket, A.progress, A.status, A.reported, A.tanggal, A.id_prioritas, A.deadline, A.problem_detail, A.problem_summary, A.filefoto, B.nama_sub_kategori, C.nama_kategori, D.nama, G.nama_prioritas, G.warna, H.lokasi, J.nama_dept FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
    LEFT JOIN pegawai D ON D.nik = A.reported
  ...
  public function daftar_tugas($id)
  {
    ...
    $query = $this->db->query("SELECT A.id_ticket, A.progress, A.status, A.reported, A.tanggal, A.tanggal_solved, A.id_prioritas, A.deadline, A.problem_detail, A.problem_summary, A.filefoto, B.nama_sub_kategori, C.nama_kategori, D.nama, G.nama_prioritas, G.warna, H.lokasi, J.nama_dept, K.nama_jabatan FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
    LEFT JOIN pegawai D ON D.nik = A.reported
    LEFT JOIN user E ON E.username = A.teknisi
  ...
  public function myticket($id)
  {
    ...
    $query = $this->db->query("SELECT A.id_ticket, A.progress, A.status, A.reported, A.tanggal, A.id_prioritas, A.deadline, A.last_update, A.problem_detail, A.problem_summary, A.filefoto, B.nama_sub_kategori, A.teknisi, C.nama_kategori, D.nama, G.nama_prioritas, G.warna, H.lokasi, J.nama_dept, K.nama AS nama_teknisi FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
    LEFT JOIN pegawai D ON D.nik = A.reported
  ...
  public function detail_ticket($id)
  {
    ...
    $query = $this->db->query("SELECT A.id_ticket, A.status, A.progress, A.tanggal, A.tanggal_proses, A.tanggal_solved, A.id_prioritas, A.deadline, A.problem_summary, A.problem_detail, A.filefoto, A.id_prioritas, A.id_sub_kategori, B.nama_sub_kategori, C.id_kategori, C.nama_kategori, D.nama, D.email, F.nama AS nama_teknisi, G.lokasi, H.nama_bagian_dept, I.nama_dept, J.nama_prioritas, J.warna, J.waktu_respon, K.nama_jabatan FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori 
    LEFT JOIN pegawai D ON D.nik = A.reported 
    LEFT JOIN user E ON E.username = A.teknisi
  ...
  public function profile($id)
  {
    ...
    $query = $this->db->query("SELECT A.nik, A.nama, A.email, A.id_jabatan, A.id_bagian_dept, B.level, C.nama_jabatan, D.id_dept, D.nama_bagian_dept, E.nama_dept FROM pegawai A 
  ...
  {
    $query = $this->db->query("SELECT A.id_ticket, A.status, A.progress, A.tanggal, A.last_update, A.tanggal_proses, A.tanggal_solved, A.problem_summary, A.problem_detail, A.filefoto, B.nama_sub_kategori, C.id_kategori, A.id_prioritas, A.deadline, C.nama_kategori, D.nama, D.email, F.nama AS nama_teknisi, G.lokasi, H.nama_bagian_dept, I.nama_dept, J.nama_prioritas FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori 
    LEFT JOIN pegawai D ON D.nik = A.reported 
    LEFT JOIN user E ON E.username = A.teknisi
  ...
  {
    //Query untuk mendapatkan data detail dari setiap ticket
    $query = $this->db->query("SELECT A.id_ticket, A.status, A.progress, A.tanggal, A.tanggal_proses, A.tanggal_solved, A.id_prioritas, A.deadline, A.problem_summary, A.problem_detail, A.filefoto, B.nama_sub_kategori, C.id_kategori, C.nama_kategori, D.nama, D.email, F.nama AS nama_teknisi, G.lokasi, H.nama_bagian_dept, I.nama_dept, J.nama_prioritas FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori 
    LEFT JOIN pegawai D ON D.nik = A.reported 
    LEFT JOIN user E ON E.username = A.teknisi
    ...
    $isiEmail .= "<div>Please respone and set the priority of the ticket in <b>ITS Web Aplication</b></div>";
    $isiEmail .= '<div>
                        <table>
                          <tbody>
                            <tr>
  ...
  {
    //Query untuk mendapatkan data detail dari setiap ticket
    $query = $this->db->query("SELECT A.id_ticket, A.status, A.progress, A.tanggal, A.tanggal_proses, A.tanggal_solved, A.problem_summary, A.problem_detail, A.filefoto, B.nama_sub_kategori, C.id_kategori, C.nama_kategori, D.nama, D.email, F.nama AS nama_teknisi, G.lokasi, H.nama_bagian_dept, I.nama_dept, J.nama_prioritas FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori 
    LEFT JOIN pegawai D ON D.nik = A.reported 
    LEFT JOIN user E ON E.username = A.teknisi
    ...
    $isiEmail .= "<div>Your ticket will be processed according to predetermined priorities. You can track your ticket in <b>ITS Web Aplication</b></div>";
    $isiEmail .= '<div>
                        <table>
                          <tbody>
                            <tr>
  ...
  public function emaildiproses($id)
  {
    ...
    $isiEmail .= "<div>Dear " . $query->nama . "</div>";
    $isiEmail .= "<div>You can track your ticket in <b>ITS Web Aplication</b></div>";
    $isiEmail .= '<div>
                        <table>
                          <tbody>
                            <tr>
  ...
  public function pilih_teknisi()
  {
    ...
    $query = $this->db->query("SELECT A.id_ticket, D.nama, F.nama_dept, A.status, A.tanggal, A.id_prioritas, A.deadline, A.problem_detail, A.problem_summary, A.filefoto, B.nama_sub_kategori, C.nama_kategori, G.nama_prioritas, G.warna, H.lokasi, I.nama_jabatan FROM ticket A 
    LEFT JOIN kategori_sub B ON B.id_sub_kategori = A.id_sub_kategori
    LEFT JOIN kategori C ON C.id_kategori = B.id_kategori
    LEFT JOIN pegawai D ON D.nik = A.reported
    LEFT JOIN departemen_bagian E ON E.id_bagian_dept = D.id_bagian_dept
